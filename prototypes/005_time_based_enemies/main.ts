...
let timeState:TimeState='day'; let player:Point={...home}; let enemies:Enemy[]=[]; let objectiveIndex=0; let switches=0;
...
function resetSession(){timeState='day';player={...home};objectiveIndex=0;switches=0;defeated={day:0,night:0};entered={aDay:false,aNight:false,bDay:false,bNight:false};finished=false;attackUntil=0;transitionUntil=0;messageElement.textContent='';summary.hidden=true;spawnEnemies();updateHud();canvas.focus();}
