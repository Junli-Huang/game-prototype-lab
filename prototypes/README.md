...
- [Prototype #003 — Fixed Map Exploration Lab](003_fixed_map_exploration/README.md)：EXP-004 TESTING / Untested；EXP-006 MAYBE；EXP-050 以 No Key / Start With Key 对比早期钥匙访问，TESTING / Untested。

当前没有 Active implementation task。下一步由 Player 依次试玩 EXP-050 No Key、Start With Key。新 Chat / Work 先读 [`../docs/project-state.md`](../docs/project-state.md) 与 [`../docs/work-items/CURRENT.md`](../docs/work-items/CURRENT.md)，不要从 Backlog 自行选择下一项实现。
