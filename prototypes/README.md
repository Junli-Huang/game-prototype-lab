...
- [Prototype #004 — Persistent Enemy Corpses Lab](004_persistent_enemy_corpses/README.md)：EXP-018 TESTING / Untested；比较 Clean Removal 与 Persistent Corpses。

当前没有 Active implementation task。下一步由 Player 依次试玩 EXP-018 Clean Removal、Persistent Corpses。新 Chat / Work 先读 [`../docs/project-state.md`](../docs/project-state.md) 与 [`../docs/work-items/CURRENT.md`](../docs/work-items/CURRENT.md)，不要从 Backlog 自行选择下一项实现。
