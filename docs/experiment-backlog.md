...
当玩家在 6×8 背包之外拥有少量明确的身体携带位置时，选择物品存放位置可能形成新的空间分配决策，而不只是获得免费容量。

### Core Variable

是否提供 Back / Chest / Waist 三个有限身体携带位置。

### Question

身体本身成为有限携带空间后，“物品放在哪里”是否会产生新的、有意义的空间分配决策？

### Minimum Scope

- Backpack Only / Body Slots Available 使用完全相同的九件固定物品。
- Body Slots Available 提供 Back / Chest / Waist，各容纳一件对应兼容物品。
- 保留 6×8 背包、拖拽、旋转、重排、丢弃、Restart 与 Session Summary。

### Non-goals

不加入战斗效果、取用速度、耐久、暴露风险、重量、更多身体部位、外挂背包或通用 Inventory Framework。
