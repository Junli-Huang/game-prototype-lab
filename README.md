...
V0.2.3 — Experiment Modes & Asset Handoff。已新增 [Prototype #001：空间背包](prototypes/001_spatial_backpack/README.md)，对应 EXP-001，当前 MAYBE。新增 [Prototype #002：篝火恢复与刷新](prototypes/002_campfire_respawn/README.md)，当前承载 EXP-007，状态 TESTING，Result: Untested。
