...
V0.3.2 — Basic Farming Loop。[Prototype #006](prototypes/006_basic_farming_loop/README.md) 测试最小的 Seed → Plant → Grow → Harvest 循环是否本身足够令人满足并愿意重复。
...
当前没有 Active implementation task。EXP-042 已完成实现与 Pages 技术验收；下一步由 Player 至少完成两次收获。不要从 Backlog 自行猜测下一任务。

## Experiment Backlog

[查看实验课题 Backlog](docs/experiment-backlog.md)。当前关键状态：EXP-001、EXP-006、EXP-013、EXP-018、EXP-048、EXP-049、EXP-050 为 MAYBE；EXP-003、EXP-004、EXP-042 为 TESTING / Untested；EXP-007 / EXP-008 为 MAYBE / Stop。
