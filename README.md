...
V0.2.2 — Experiment Modes & Controlled Comparison。已新增 [Prototype #001：空间背包](prototypes/001_spatial_backpack/README.md)，对应 EXP-001，当前 MAYBE。新增 [Prototype #002：篝火恢复与刷新](prototypes/002_campfire_respawn/README.md)，当前承载 EXP-007，状态 TESTING，Result: Untested。
...
[查看全部 47 个实验课题](docs/experiment-backlog.md)。首批候选中 EXP-001 为 MAYBE，EXP-007 为 TESTING，6 项为 READY，39 项为 IDEA。任何候选机制都不是最终设计。
