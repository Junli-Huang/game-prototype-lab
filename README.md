...
V0.3.1 — Time-Based Enemies。[Prototype #005](prototypes/005_time_based_enemies/README.md) 测试固定地图中可预测的 Day / Night 敌人分布是否让玩家开始选择“什么时候去哪里”。
...
当前没有 Active implementation task。EXP-013 已完成实现与 Pages 技术验收；下一步由 Player 完成 Day / Night 路线试玩。不要从 Backlog 自行猜测下一任务。

## Experiment Backlog

[查看实验课题 Backlog](docs/experiment-backlog.md)。当前关键状态：EXP-001、EXP-006、EXP-018、EXP-048、EXP-049、EXP-050 为 MAYBE；EXP-003、EXP-004、EXP-013 为 TESTING / Untested；EXP-007 / EXP-008 为 MAYBE / Stop。
